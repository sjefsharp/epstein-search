...
import { DOJSearchParams, DOJSearchResponse, DOJDocument, DOJAPIResponse } from "./types";
...
export function transformDOJHits(data: DOJAPIResponse): DOJDocument[] {
 ...
 */
export async function searchDOJ(params: DOJSearchParams): Promise<DOJSearchResponse> {
  ...
  try {
    ...
    const documents: DOJDocument[] = transformDOJHits(data);
